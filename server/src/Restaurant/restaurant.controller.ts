...
export class restaurantController{
    ...
    async addrestaurant(
        ...
        return {id:restid,message:"restaurant Added Successfully!",response:200};
    }
    ...
    async updaterestaurant(
        ...
        const updated= await this.restaurantService.updaterestaurant(id,name,desc,rating);
        return {"response":200,"message":"restaurant Updated Successfully!!","Restraurant":updated};
    }
